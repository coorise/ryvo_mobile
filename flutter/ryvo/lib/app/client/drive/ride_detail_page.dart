...
class ClientRideDetailPage extends ConsumerWidget {
  const ClientRideDetailPage({super.key, required this.tripId});
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return PortalPageShell(
      ...
      expand: false,
      child: PortalRideDetailPanel(area: PortalArea.client, tripId: tripId),
    );
  }
}
