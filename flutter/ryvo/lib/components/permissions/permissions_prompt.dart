...
import 'package:ryvo/services/permission_service.dart';
...
class PermissionsPrompt {
  ...
  static Future<void> maybeShow(BuildContext context, PortalArea area) async {
    if (_shownThisSession) return;

    final specs = permissionsForArea(area);
    ...
    await _showDialog(context, area, specs, statuses, prefs);
  }
...
class _PermissionRow extends StatelessWidget {
  ...
  IconData _iconFor(String id) {
    return switch (id) {
      'location' || 'location_always' => LucideIcons.mapPin,
      ...
      'notification_policy' => LucideIcons.bellRing,
      'exact_alarm' => LucideIcons.alarmClock,
