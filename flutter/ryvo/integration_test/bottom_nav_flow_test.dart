...
void main() {
  ...
  testWidgets('driver bottom nav matches spec', (tester) async {
    app.main();
    await tester.pumpAndSettle(const Duration(seconds: 4));
    await _signIn(tester, 'driver@ryvo-line.com', 'Driver@123');
    ...
    await tester.pumpAndSettle(const Duration(seconds: 4));
    final onLiveHome = find.text('Go online').evaluate().isNotEmpty ||
        find.text('Live').evaluate().isNotEmpty;
    expect(onLiveHome, isTrue);
  });
}
